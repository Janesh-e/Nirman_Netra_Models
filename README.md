...
├── sample_outputs/
│   ├── building_spacenet_predictions.png
│   ├── building_custom_predictions.png
│   ├── change_detection_predictions.png
│   └── waterbody_predictions.png
├── epoch_details/
...
Below are some sample predictions generated by the trained models on test or unseen aerial imagery. Each output demonstrates the model’s capability to accurately segment and identify key features such as buildings, waterbodies, and areas of change.

### Building Detection – SpaceNet (Rio)

![OriginalImage/ActualMask/PredictedMask](sample_outputs/building_spacenet_predictions.png)

### Building Detection – Self-Annotated Dataset

![OriginalImage/PredictedMask/ActualMask](sample_outputs/building_custom_predictions.png)

### Change Detection – LEVIR-CD

![Before/After/GroundTruth/Prediction](sample_outputs/change_detection_predictions.png)

### Waterbody Detection

![OriginalImage/PredictedMask/ActualMask](sample_outputs/waterbody_predictions.png)

> All predictions were generated on `.tif` images with real-world geo-metadata. Visual results have been converted to `.png` format for clarity in presentation.
